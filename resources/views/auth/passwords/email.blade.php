  ...
  <head>
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .auth-alert.success { background: #ecfdf3; color: #085d3a; border: 1px solid #abefc6; }
      .auth-alert.error { background: #fef3f2; color: #7a271a; border: 1px solid #fecdca; }
      .auth-actions { display: flex; justify-content: center; margin-top: 14px; }
      .auth-link { font-size: 13px; font-weight: 650; color: var(--accent); text-decoration: none; }
